...
def export_sarif(args: argparse.Namespace) -> Dict[str, Any]:
    ...
    sarif = {
        ...
        "version": "2.1.0",
        "runs": [{
            "tool": {"driver": {"name": "SBOM Security Toolkit", "semanticVersion": "2.10.0", "informationUri": "https://github.com/hellnbak/sbom_security_toolkit", "rules": list(rules.values())}},
